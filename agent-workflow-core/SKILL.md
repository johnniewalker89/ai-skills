...
- Owns: task mode, local context workspace, `environment.md` lifecycle and local runtime resolution, task snapshots, optional agent logs, planning, approval acquisition/retention and stop behavior, decision-grade checkpoints, validation framing, and final self-review.
