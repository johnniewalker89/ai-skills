...
- `subagent-orchestration` — подключается, когда нужно спланировать или организовать работу субагентов.
...
Skills не хранят личные пути, credentials и task snapshots внутри себя. Они являются переносимым ядром, а локальные детали живут в выбранной пользователем рабочей области контекста.
